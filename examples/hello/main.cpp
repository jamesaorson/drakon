...
struct TriangleRenderable : public drakon::Renderable {
#if defined(WIN32) || defined(_WIN64)
    TriangleRenderable() { this->pipelineConfig = TriangleRenderable::defaultPipelineConfig; }

    inline static const char* shaderSource =
    ...
    inline static drakon::RenderPipelineConfig defaultPipelineConfig =
